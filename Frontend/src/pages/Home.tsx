...
const Hero = () => {
  ...
  return (
    <main
      className="relative bg-cover bg-center bg-no-repeat min-h-[calc(100vh-6rem)] flex lg:mt-20 flex-col lg:flex-row items-center justify-between px-4 lg:px-20"
      style={{
        backgroundImage: `url('/bg.jpg')`, // ✅ Replace with your image name placed in `public/`
      }}
    >
      ...
      {/* Content */}
      <div className="relative max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
